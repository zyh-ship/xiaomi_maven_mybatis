			...
			<div class="center-block" style="margin-top: 80px;">
				<form id="form1" class="form-horizontal" action="userservlet?method=register" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span class="help-block " id="usernameMsg">${error.usernameError}</span></p>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span id="helpBlock" class="help-block ">${empty error.passwordError? '请输入6位以上字符':error.passwordError}</span></p>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span id="helpBlock" class="help-block ">${empty error.emailError? '填写正确邮箱格式':error.emailError}</span></p>
						</div>
					</div>
					<div class="form-group">
