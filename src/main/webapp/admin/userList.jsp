...
<script type="text/javascript">
	...
	function loadUser(){
		$.ajax({
			url:"${pageContext.request.contextPath}/adminuserservlet?method=findAll",
			method:"post",
	...
	$(function(){
		...
		$("#search").click(function(){
			...
			//使用ajax 进行异步交互
			$.ajax({
				url:"${pageContext.request.contextPath}/adminuserservlet?method=searchUser&username="+username+"&gender="+gender,
				method:"post",
				success:function(data){
					if(data==0){
						alert("未找到指定内容");
